...
export default function Showcase() {
  return (
    <section className="border-t-border dark:border-t-darkBorder dark:bg-darkBg border-t-2 bg-bg py-16 font-base">
      <div className="mx-auto max-w-[1400px] px-4">
        <Tabs defaultValue="screenshots" className="w-full">
          <TabsList className="mx-auto mb-8 w-full max-w-md grid grid-cols-2 p-1.5">
            <TabsTrigger 
              value="screenshots" 
